      ...
      <div className={styles.header}>
        <div className={styles.headerLeft}>
          ...
          <div>
            ...
            <p className={styles.desc}>Access NimOS securely from anywhere — DDNS, SSL &amp; HTTPS in one place</p>
          </div>
        </div>
      </div>
            ...
            {provider.supportsDnsChallenge && (
              <div className={ra.highlightBox}>
                ...
                <span>
                  ...
                  without opening port 80. NimOS uses your API token to create the validation record automatically.
                </span>
              </div>
            )}
      ...
      <div className={`${ra.stepCard} ${activeStep === 3 ? ra.stepCardActive : ''}`}>
        <div className={ra.stepHeader} onClick={() => setActiveStep(activeStep === 3 ? 0 : 3)}>
          ...
          <div className={ra.stepTitle}>
            ...
            <div className={ra.stepSub}>Serve NimOS over HTTPS on port {httpsPort}</div>
          </div>
          <div className={ra.stepStatus}>
          ...
          <div className={ra.stepBody}>
            ...
            {httpsOk && (
              <div className={ra.successBanner} style={{ marginTop: 8 }}>
                <LockIcon size={14} />
                <span>NimOS is serving HTTPS at <span className={styles.mono}>https://{fullDomain}:{httpsPort}</span></span>
              </div>
            )}
