#!/usr/bin/env bash
# ╔══════════════════════════════════════════════════════════════╗
# ║  NimOS Beta 3 Installer                                  ║
# ║  Transforms Ubuntu/Debian Server into a NimOS NAS        ║
# ║  curl -fsSL https://raw.githubusercontent.com/              ║
# ║    andresgv-beep/nimbus-os-beta-3/main/install.sh | sudo bash║
# ╚══════════════════════════════════════════════════════════════╝
...
NIMBUS_REPO="https://github.com/andresgv-beep/nimbus-os-beta-3"
NIMBUS_BRANCH="main"
...
install_nimos() {
  ...
  TARBALL_URL="https://github.com/andresgv-beep/nimbus-os-beta-3/archive/refs/heads/${NIMBUS_BRANCH}.tar.gz"
...
[Unit]
Description=NimOS - NAS Operating System
...
start_nimbusos() {
  ...
  warn "NimOS may still be starting. Check: systemctl status nimbusos"
}
